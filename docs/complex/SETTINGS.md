...
This document documents `quickshell/components/Settings.qml` (3,050 lines), the primary control hub for Dark Niri.
...
3. **Quick Toggle Grid**:
   ...
   - Audio Output Mute
   - Microphone Mute
   - Screencast Record Trigger (Toggles start when idle, stop when recording)
